...
public class IntegerExam {
    public static void main(String[] args) {
        ...
        // 파싱(parsing)은 어떤 데이터가 적합한 데이터인지 검증하는 절차.
        // parseInt(문자열, [진법]) : 데이터를 정수형으로 파싱해주는 메소드
        // [진법]은 옵션, 적지 않으면 기본 10진법
        String _age="20";
        ...
        // ↑ 정수형을 물어보면 이 친구가 담당
        System.out.println("2진수를 10진수 정수형으로 변환 : "+binaryDecimal);
        System.out.println("8진수를 10진수 정수형으로 변환 : "+octalDecimal);
        System.out.println("16진수를 10진수 정수형으로 변환 : "+hexDecimal);

        String str="100"; // 2진수 100은 10진수로 '4'입니다.
        int result=Integer.parseInt(str, 2);
        System.out.println("2진수 '100'은 10진수로 '4'입니다. : "+result);

        System.out.println("부호 메소드 사용");
        System.out.println("Integer.sigum(50) : "+Integer.signum(50));
        System.out.println("Integer.sigum(0) : "+Integer.signum(0));
        System.out.println("Integer.sigum(-15) : "+Integer.signum(-15));

        Scanner scan=new Scanner(System.in);
        System.out.println("정수 입력 : ");
        String su01=scan.nextLine();
