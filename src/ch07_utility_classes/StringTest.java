...
public class StringTest {
    public static void main(String[] args) {
        ...
        String stemp;
        stemp=str1.toLowerCase()+" "+str2.toUpperCase(); // str1을 소문자로 바꿔라
        System.out.println(stemp);

        StringBuffer sb=new StringBuffer(stemp);
        System.out.println(sb.reverse()); // 글자 배열 뒤집기
        ...
        System.out.println("a로 시작하나요?"+somefile.startsWith("a.")); // ↔ endsWish()
        ...
        for (int i = 0; i < filename.length; i++) {
            if(filename[i].toLowerCase().endsWith(".ppt")){
                ...
                System.out.println(filename[i]+"는(은) 기타 파일입니다.");
            }
        }
