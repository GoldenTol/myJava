...
public class DecimalFormatEx {
    public static void main(String[] args) {
        ...
        String pattern="###,###.00"; // #은 값이 없을 때 보여지지 않습니다.
        DecimalFormat df1=new DecimalFormat(pattern);
        String result=df1.format(su);
        System.out.println("결과01 : "+result); // 숫자 아니고 문자열입니다.

        pattern="000,000.00"; // 0은 값이 없어도 0으로 보여집니다.
        ...
        int gaesu=10;
        System.out.println("랜덤한 수 10개 만들기");
