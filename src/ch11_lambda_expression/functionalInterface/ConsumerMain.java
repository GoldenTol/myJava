...
import ch11_lambda_expression.model.Saram;
...
public class ConsumerMain {
    public static void main(String[] args) {
        ...
        csmr.accept("대한민국");
        // 매개 변수를 param으로 집어 넣었고 param에 "대한민국"을 입력
        ...
        // '~님' 반갑습니다. 의 형식으로 출력하는 Consumer 람다식 만들기
        ...
        // 미성년자 체크) Consumer.accept("김철수", 12); → '김철수'님은 미성년자입니다.
        ...
        // Saram 클래스와 ObjIntConsumer를 이용하여 다음 요구 상항대로 프로그램을 구현하세요.
        // 국영수 3과목의 총점에 입력한 점수를 뺄셈하는 프로그램 구현
        // consumer.accept(new Saram(null, "김철수", 40, 50, 60), 30);
        // 출력 예시) 김철수 총점은 120입니다.
        ObjIntConsumer<Saram> minusTotal=(saram, minus)->{
            String message="%s님 총점은 (%d - %d) = %d점 입니다.\n";
