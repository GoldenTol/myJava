...
public class FunctionMain01 {
    public static void main(String[] args) {
        ...
        System.out.println("정수 2개의 산술 평균을 double타입으로 반환");
        BiFunction<Integer, Integer, Double> biFunction=(first, second)->((double)first+second)/2;
        double result02=biFunction.apply(30, 40);
        System.out.println("두 숫자의 산술평균 : "+result02);
