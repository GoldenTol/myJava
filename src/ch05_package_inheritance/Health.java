...
public class Health extends Human {
    ...
    public Health(String name, String gender, double heihght, double weight){
        super(name, gender, heihght, weight);
        this.calculate();
        this.output2();
//        // 문장안에 메소드 안에서만 문장 출력 가능
//        System.out.println("이릅 : "+super.getName());
    }
